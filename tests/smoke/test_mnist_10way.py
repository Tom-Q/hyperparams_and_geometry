"""Smoke test for mnist_10way: trains one network and checks the recorded
...
# A config that should solve the task (val_acc >= 0.90) within a few epochs.
CONFIG = {
    "hidden_size":   64,
    "depth":         2,
    "batch_size":    64,
