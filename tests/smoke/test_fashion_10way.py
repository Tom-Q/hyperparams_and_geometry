"""Smoke test for fashion_10way: trains one network and checks the recorded
...
# A config that should solve the task (val_acc >= 0.85) within a few epochs.
CONFIG = {
    "hidden_size":   64,
    "depth":         2,
    "batch_size":    64,
...
def test_train_and_activations(tmp_path):
    ...
    run_dir = tmp_path / "fashion_10way"
    train_network(
