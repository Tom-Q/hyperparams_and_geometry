"""Smoke test: FourRooms. Run from repo root:
    python tests/fourrooms.py
    python tests/fourrooms.py --hidden-size 128 --gamma 0.9
"""
import argparse, sys
...
final = train_network(
    task        = task,
    config      = config,
    run_dir     = Path("experiments_test") / "fourrooms",
